...
public class BikeView_Brand extends AppCompatActivity {
    TextView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_view_brand);
        ...
        BikeView_Brand.BackTaskBrand backTaskBrand=new BikeView_Brand.BackTaskBrand();
...
//      spin.setAdapter(aa);
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    get_brand=item;
                    layoutset.setVisibility(View.INVISIBLE);
                    BikeView_Brand.BackTaskModel backTaskModel1=new BikeView_Brand.BackTaskModel();
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(BikeView_Brand.this);
