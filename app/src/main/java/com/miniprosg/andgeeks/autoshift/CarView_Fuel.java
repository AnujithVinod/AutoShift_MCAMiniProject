...
public class CarView_Fuel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_view_fuel);
        ...
        spinnerfuel.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                CarView_Fuel.BackTaskBrand backTaskBrand = new CarView_Fuel.BackTaskBrand();
...
//      spin.setAdapter(aa);
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    ...
                    layoutset.setVisibility(View.INVISIBLE);
                    CarView_Fuel.BackTaskModel backTaskModel1=new CarView_Fuel.BackTaskModel();
...
//        s.setAdapter(adapter);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(CarView_Fuel.this);
