...
public class BikeView_Fuel extends AppCompatActivity {
    ...
    String get_brand,get_model,get_fuel="Petrol";

    MaterialSpinner spinnerbrand,spinnermodel,spinnerfuel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_view_fuel);
        ...
        spinnerfuel = (MaterialSpinner) findViewById(R.id.spinFuel );
        spinnerfuel.setItems("Select Fuel Type","Petrol", "Diesel", "Electric", "Hybrid");

        spinnerfuel.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                BikeView_Fuel.BackTaskBrand backTaskBrand = new BikeView_Fuel.BackTaskBrand();
    ...
    public class BackTaskBrand extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost(base_url+"spinnerload/getbrand_fuel.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
                nameValuePairs.add(new BasicNameValuePair("carorbike", "CBIKE"));
                nameValuePairs.add(new BasicNameValuePair("cf_type", get_fuel));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    get_brand=item;
                    layoutset.setVisibility(View.INVISIBLE);
                    BikeView_Fuel.BackTaskModel backTaskModel1=new BikeView_Fuel.BackTaskModel();
    ...
    public class BackTaskModel extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                HttpClient httpclient = new DefaultHttpClient();
                HttpPost httppost = new HttpPost(base_url+"spinnerload/getmodel_fuel.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(BikeView_Fuel.this);
