...
public class CarView_Body extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_view_body);
        ...
        spinnerbody.setItems("Select Body Type","Sedan","Compact Sedan", "Coupe", "Hatchback"
        ...
        spinnerbody.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                CarView_Body.BackTaskBrand backTaskBrand = new CarView_Body.BackTaskBrand();
    ...
    public class BackTaskBrand extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("cd_bodytype", get_body));
...
//      spin.setAdapter(aa);
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    ...
                    layoutset.setVisibility(View.INVISIBLE);
                    CarView_Body.BackTaskModel backTaskModel1=new CarView_Body.BackTaskModel();
...
//        s.setAdapter(adapter);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(CarView_Body.this);
