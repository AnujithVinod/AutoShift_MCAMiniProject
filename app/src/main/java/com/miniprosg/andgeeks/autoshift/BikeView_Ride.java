...
public class BikeView_Ride extends AppCompatActivity {
    ...
    String get_brand,get_model,get_body="Street";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bike_view_ride);
        ...
        spinnerbody = (MaterialSpinner) findViewById(R.id.spinBody);
        spinnerbody.setItems("Select Ride Type","Street","Cruiser", "Scooter", "Sport");

        spinnerbody.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                ...
                BikeView_Ride.BackTaskBrand backTaskBrand = new BikeView_Ride.BackTaskBrand();
    ...
    public class BackTaskBrand extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost(base_url+"spinnerload/getbrand_body.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
                nameValuePairs.add(new BasicNameValuePair("carorbike", "CBIKE"));
                nameValuePairs.add(new BasicNameValuePair("bd_ridetype", get_body));
...
//      spin.setAdapter(aa);
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    ...
                    layoutset.setVisibility(View.INVISIBLE);
                    BikeView_Ride.BackTaskModel backTaskModel1=new BikeView_Ride.BackTaskModel();
...
//        s.setAdapter(adapter);
    ...
    public class BackTaskModel extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                HttpClient httpclient = new DefaultHttpClient();
                HttpPost httppost = new HttpPost(base_url+"spinnerload/getmodel_body.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
...
//        s.setAdapter(adapter);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(BikeView_Ride.this);
...
//                                Toast.makeText(getApplicationContext(),response.getString("b_reldate"), Toast.LENGTH_SHORT).show();
