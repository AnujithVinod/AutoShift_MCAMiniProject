...
public class CarView_Budget extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_view_budget);
    ...
    public void fill_model_db(View view)
    {
        ...
        else
        {
            ...
            CarView_Budget.BackTaskBrand backTaskBrand = new CarView_Budget.BackTaskBrand();
...
//      spin.setAdapter(aa);
            ...
            spinnerbrand.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
                ...
                @Override public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                    ...
                    layoutset.setVisibility(View.INVISIBLE);
                    CarView_Budget.BackTaskModel backTaskModel1=new CarView_Budget.BackTaskModel();
...
//        s.setAdapter(adapter);
    ...
    private void displayLoader() {
        pDialog = new ProgressDialog(CarView_Budget.this);
